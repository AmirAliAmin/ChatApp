...
export default function ChatContainer() {
  ...
  const {selectedUser, setSelectedUser,message, sendMessage,
  ...
  return selectedUser?(
    <div className='h-[100%] sm:h-full overflow-scroll relative backdrop-blur-lg'>
      {/* Header */}
      ...
      <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
        <div className='flex-1 flex items-center bg-gray-100/12 px-3 rounded-full'>
          <input onChange={(e)=>setInput(e.target.value)} value={input} type="text" placeholder='Send a Message' className='flex-1 text-sm p-3 border-none rounded-lg outline-none text-white placeholder-gray-500' onKeyDown={(e)=>e.key === "Enter" ? handleSendMessage(e) : null} />
